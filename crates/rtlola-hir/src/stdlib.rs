...
pub struct FuncDecl {
    ...
    /// first the named arguments, then optional, a list of remaining arguments
    pub(crate) parameters: (Vec<AnnotatedType>, Option<AnnotatedType>),
...
lazy_static! {
    ...
    static ref WIDEN: FuncDecl = FuncDecl {
        ...
        parameters: (vec![AnnotatedType::Param(0, "T".to_string())], None),
    ...
    static ref MIN: FuncDecl = FuncDecl {
        ...
        parameters: (vec![AnnotatedType::Param(0, "T".to_string()), AnnotatedType::Param(0, "T".to_string())], None),
        return_type: AnnotatedType::Param(0, "T".to_string()),
    };
    ...
    static ref MATCHES: FuncDecl = FuncDecl {
        ...
        parameters: (vec![AnnotatedType::Param(0, "T".to_string()), AnnotatedType::String], None),
    ...
    static ref BYTES_AT: FuncDecl = FuncDecl {
        ...
        generics: vec![],
        parameters: (vec![AnnotatedType::Bytes, AnnotatedType::UInt(8)], None),
    ...
    static ref FORMAT: FuncDecl = FuncDecl {
        name: FunctionName{name: "format".to_string(), arg_names: vec![None], repeating: true},
        generics: vec![],
        parameters: (vec![AnnotatedType::String], Some(AnnotatedType::Any)),
