...
impl Mir {
    ...
    pub(crate) fn from_hir(_hir: RtLolaHir<CompleteMode>) -> Mir {
        ...
        //     fn lower_event_based(&self, sr: SRef) -> mir::EventDrivenStream {
        ...
        //     fn lower_periodic(&self, sr: SRef) -> mir::TimeDrivenStream {
        ...
        //     fn lower_instance_template(&self, _sr: SRef) -> Option<InstanceTemplate> {
